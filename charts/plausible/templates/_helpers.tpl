...
{{- if .Values.plausible.fullnameOverride }}
{{- .Values.plausible.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.plausible.nameOverride }}
...
{{- default (include "plausible.fullname" .) .Values.plausible.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.plausible.serviceAccount.name }}
{{- end }}
{{- end }}
